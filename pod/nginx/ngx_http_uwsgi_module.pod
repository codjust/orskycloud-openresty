...
B<syntax:> uwsgi_bind I<I<C<address>> [transparent] E<verbar> C<off>>
...
L<non-idempotent|http://tools.ietf.org/html/rfc7231#section-4.2.2>
method
...
The cases of C<http_500> and C<http_503> are
...
Standard
L<CGI
environment variables|http://tools.ietf.org/html/rfc3875#section-4.1>
...
If a directive is specified with C<if_not_empty> (1.1.11) then
